    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8 pt-28 animate-fade-in relative z-10">
        ...
        {!selectedCategory ? (
          <>
            {!showDisciplines ? (
            <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mb-16 mt-8 animate-fade-in-up">
              {/* Desktop Layout */}
              <div className="hidden lg:block flex-1 text-left">
                ...
                {!showDisciplines && (
                  <button 
                    ...
                    className="mb-8 px-8 py-4 bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-xl shadow-[0_0_20px_rgba(99,102,241,0.4)] transition-all flex items-center gap-2 text-lg"
                  >
              ...
              <div className="flex lg:hidden flex-col gap-4 w-full">
                ...
                <p className="text-slate-400 text-sm leading-relaxed mt-2 text-left mb-6">
                  We analyze decadal examination papers using a mathematical regression engine combined with taxonomy classifications to engineer your ultimate path to the 100th percentile.
                </p>
                {!showDisciplines && (
                  <button 
                    onClick={() => setShowDisciplines(true)} 
                    className="mb-4 px-6 py-3 bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-xl shadow-[0_0_20px_rgba(99,102,241,0.4)] transition-all flex items-center justify-center gap-2"
                  >
              ...
              <div className="mb-12 animate-fade-in">
                ...
                <Layers className="text-indigo-500" size={28} /> Choose Your Discipline
              </h2>
